...
import examples.stateless.FeeManagement;
import examples.stateless.EmployeeManagement;

public class EmployeeServlet extends HttpServlet {

    private final String TITLE = 
        "Chapter 9: Write Locking Example";
    
    private final String DESCRIPTION = 
        "This example demonstates the basics of using a write lock.  Turn off " +
        "locking and redeploy to see the data being computed incorrectly.";
