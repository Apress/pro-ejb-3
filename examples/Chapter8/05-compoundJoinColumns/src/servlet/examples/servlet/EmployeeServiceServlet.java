...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 8: Using Compound Join Columns Example";
    
    private final String DESCRIPTION = 
        "This example demonstates the basics of using compound join columns.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Employee emp : service.findAllEmployees()) {
            out.print(emp + " " + emp.getProjects().size() + "<br/>");
            out.print(emp + " " + emp.getManager() + "<br/>");
        }
        
        out.println("</br>Projects: </br>");
        for (Project p : service.findAllProjects()) {
            out.print(p + " " + p.getEmployees().size() + "<br/>");
        }       
        printHtmlFooter(out);
    }
