...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 8: Using Compound Primary Keys and Multile Tables Example";
    
    private final String DESCRIPTION = 
        "This example demonstates the basics of using compound primary keys with multiple tables.";
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Employee emp : service.findAllEmployees()) {
            out.print(emp + "<br/>");
            out.print(emp.getManager() + "<br/>");
            emp.getComments();
            out.print(emp.getPhoto() + "<br/>");
        }
