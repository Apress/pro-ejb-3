...
CREATE TABLE FT_EMP (ID INTEGER NOT NULL, NAME VARCHAR(255), S_DATE DATE, VACATION INTEGER, 
                     SALARY BIGINT, PENSION BIGINT, MANAGER INTEGER, PRIMARY KEY (ID));
CREATE TABLE PT_EMP (ID INTEGER NOT NULL, NAME VARCHAR(255), S_DATE DATE, VACATION INTEGER, 
                     H_RATE FLOAT, MGR INTEGER, PRIMARY KEY (ID));
CREATE TABLE CONTRACT_EMP (ID INTEGER NOT NULL, NAME VARCHAR(255), S_DATE DATE, D_RATE INTEGER, TERM INTEGER, PRIMARY KEY (ID));


INSERT INTO CONTRACT_EMP (ID, NAME, S_DATE, D_RATE, TERM) VALUES (1, 'John', {d '2001-01-01'}, 500, 12);
INSERT INTO CONTRACT_EMP (ID, NAME, S_DATE, D_RATE, TERM) VALUES (2, 'Paul', {d '2002-04-08'}, 600, 24);
INSERT INTO CONTRACT_EMP (ID, NAME, S_DATE, D_RATE, TERM) VALUES (3, 'Sarah', {d '2003-06-10'}, 700, 18);
