...
public class EmployeeServiceServlet extends HttpServlet {
    ...
    private final String TITLE = 
        "Chapter 8: Using Table per Class Inheritance Example";
    
    private final String DESCRIPTION = 
        "This example demonstates the basics of using separate table for each entity in the inheritance hierarchy.";
