...
public class OrderBrowserServlet extends HttpServlet {
    ...
    private final String DESCRIPTION = 
        ...
        "The simple example allows you to browse any orders that have been created. " +
        "NOTE: The example doesn't show the details of issuing/parsing the jdbc to create " +
        "orders, hence no orders are displayed.  It only how to use the lifecycle callbacks.";
