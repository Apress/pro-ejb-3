...
public class EmployeeServlet extends HttpServlet {
    ...
    private final String DESCRIPTION = 
        "This example demonstates how to map a byte[] to a LOB column.</br> " +
        ...
        "fetch=LAZY for simple fields, although this feature is not currently" +
        "supported by TopLink Essentials";
